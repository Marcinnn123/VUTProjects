...
void List_Dispose( List *list ) {
	if(list->firstElement != NULL){
		...
		do{ // dokud nejsme na konci seznamu
			list->firstElement = list->firstElement->nextElement; //prvni prvek posuneme na dalsi
			free(deletingElement); // odstranime aktualni prvni prvek
			deletingElement = list->firstElement; //prvek ktery budeme odstranovat posuneme dal
...
void List_InsertFirst( List *list, int data ) {
	...
	if(list->firstElement == NULL){ // pokud vkladame do prazdneho seznamu
		insertingElement->data = data; 
		insertingElement->nextElement = NULL; 
		list->firstElement = insertingElement; 
	}else{ // pokud v seznamu uz neco je
		insertingElement->data = data; 
		insertingElement->nextElement = list->firstElement; 
		list->firstElement = insertingElement; 
}
	}
